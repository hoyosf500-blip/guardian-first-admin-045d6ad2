...
/**
 * Teléfonos por país: la definición se mudó a
 * `supabase/functions/_shared/telefonoWhatsapp.ts` para que el SERVIDOR use
 * exactamente la misma —al mandar una plantilla de WhatsApp tiene que armar el
 * destinatario, y dos copias del normalizador terminan mandándole el mensaje a
 * otro número. Se re-exporta acá para no tocar las pantallas que ya lo importan.
 */
export {
  ...
  normalizeGuatemalanPhone,
  isValidGuatemalanPhone,
  normalizePhoneForCountry,
  isValidPhoneForCountry,
  getWhatsAppPhone,
} from '../../supabase/functions/_shared/telefonoWhatsapp';
