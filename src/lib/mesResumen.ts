...
export function buildMesResumen(summary: LogisticsSummary | null): MesResumen | null {
  ...
  const buckets: FunnelBucket[] = [
    ...
    {
      key: 'novedad',
      label: 'En novedad o en agencia',
      sublabel: 'Novedad de transportadora + paquetes esperando retiro en agencia',
      count: novedades,
...
const BUCKET_META: Array<{ key: string; label: string; sublabel?: string }> = [
  ...
  { key: 'novedad',     label: 'En novedad o en agencia',   sublabel: 'Novedad de transportadora + paquetes esperando retiro en agencia' },
