...
export default function CrmCallView({
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        // otra ciudad/depto, la descartamos antes de cachearla — exponerla
        // pondría al cliente en riesgo de despacho equivocado.
  ...
  useEffect(() => {
    ...
    // score (mismos cortes que visualDecisionCrm: 80=green/50=yellow) para que
    // una green urbana fuerte NO se reescriba en falso a yellow.
          ...
          <div className="text-sm text-muted-foreground mb-3 leading-relaxed space-y-3">
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              ...
              <div className="flex items-center gap-3 p-3 rounded-2xl bg-card/40 border border-border hover:border-border-strong transition-colors duration-200">
                ...
                {/* Con variantes (zapatos: talla/color) se lista UNA LÍNEA POR
                    PAR. Antes salía el nombre repetido —"Sneakers, Sneakers"—
                    y la asesora no podía decirle al cliente qué tallas venían.
                    Sin variantes (o en pedidos viejos, que no tienen el dato)
              ...
              <div className="flex flex-col gap-1.5 text-xs">
                ...
                <AddressFeedbackCard
                  ...
                  suggestedAddress={
                    ...
                    // stale persistida por una edge function vieja que no
                    // coincide con la ciudad/depto del pedido, NO la mostramos.
                  ...
                  addressSuggestion={(() => {
                    ...
                    // descartamos para no exponer al cliente a un despacho
                    // equivocado.
                    if (
