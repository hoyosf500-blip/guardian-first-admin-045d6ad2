      ...
      >
        ...
        {o.retryCount && !o.result && (
          <div className="relative flex items-center gap-2 mb-3 rounded-2xl bg-success/10 border border-success/30 px-3 py-2 pl-4 shadow-card3d">
            ...
            <span className="text-[11px] font-semibold text-success">
              Luz verde ✓ — ya pasó {COOLDOWN_LABEL}, volvé a llamar (intento {Number(o.retryCount) + 1}/{MAX_DAILY_ATTEMPTS})
            </span>
          </div>
        )}
        ...
        <div className="relative mb-4 space-y-3">
          ...
          <div className="grid gap-2 sm:grid-cols-2">
            ...
            {/* Ficha de CONFIRMAR. Seguimiento (CrmCallView) usa el MISMO
                componente — no volver a copiar el markup acá. */}
            <ProductoTile producto={o.producto} lineas={o.productosDetalle} />
            {o.valor > 0 && (
