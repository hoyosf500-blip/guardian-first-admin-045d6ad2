-- Paso A: Re-categorizar movimientos de wallet existentes (idempotente)
...
-- Paso B: financial_summary v5 con filtros permisivos + métricas de cancelados
...
COMMENT ON FUNCTION public.financial_summary(DATE, DATE) IS
  'Fase A v5 — utilidad bruta operativa con filtros permisivos (LIKE) y métricas de cancelados.';