...
-- === operator_productivity_stats(text) ===
...
-- === admin_daily_reports_range(date, date) ===
...
-- === admin_operator_shifts_range(date, date) ===
...
-- === admin_operator_actions_per_day(date, date) ===
...
-- === logistics_summary(date, date, text) ===
...
-- === logistics_by_carrier(date, date) ===
...
-- === logistics_by_carrier(date, date, text) ===
...
-- === logistics_by_city(date, date, integer) ===
...
-- === logistics_by_product(date, date, integer) ===
...
-- === logistics_cost_basis(date, date, text) ===
...
-- === product_profitability(date, date, integer) ===
...
-- === wallet_summary(timestamptz, timestamptz) ===
...
-- === wallet_daily_series(timestamptz, timestamptz) ===
...
-- === wallet_ganancia_neta(timestamptz, timestamptz) ===
...
-- === orders_estado_breakdown(date, date) ===
...
-- === novedades_root_cause(date, date) ===
